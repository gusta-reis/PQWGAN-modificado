#python train.py --cl 01234 --dataset mnist --patches 7 --layers 4 --out_folder results --qcritic --batch_size 50 --checkpoint 1930
import os
import argparse
import math
import numpy as np
...
from utils.wgan_reformulada import compute_gradient_penalty
...
def train(classes_str, dataset_str, patches, layers, n_data_qubits, batch_size, out_folder, checkpoint, randn, patch_shape, qcritic):
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu") # Seleciona cuda como o dispositivo
